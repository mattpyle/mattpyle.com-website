...
export const GET: APIRoute = async ({ site }) => {
  ...
  lines.push(`- [ARD catalogue](${base}/.well-known/ard.json): this site's Agentic Resource Discovery publisher catalogue, per the ARD specification v0.91. Four entries — the A2A Agent Card, the MCP discovery document, and the two Agent Skills — each pointing at the artifact's own URL rather than restating it. The fuller description is in agents.md.`);
